...
const Dashboard = () => {
  ...
  // provide realtime dashboard history
  useEffect(()=>{
     getDashboardData()
  }, [])
  ...
  return (
    ...
    { // yadi loading true to spinner else recent creations
      loading ? 
      (
        <div className='flex justify-center items-center h-3/4'>
          <div className='animate-spin rounded-full h-12 w-12 border-3 border-red-700 border-t-transparent'></div>
        </div>
      )
      :
      (
